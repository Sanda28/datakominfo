...
class Admin extends CI_Controller
{
    ...
    {
        $data = $this->ModelData->chartmenara();
        echo json_encode($data);

    }
    public function loadchartwifi()
    {
        $data = $this->ModelData->chartwifi();
        echo json_encode($data);
    ...
    public function profil()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('backend/profil/profil', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function ubahProfil()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('backend/profil/ubah-profil', $data);
            $this->load->view('templates/footer');
        } else {
    ...
    public function ubahPassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('backend/profil/gantipassword', $data);
            $this->load->view('templates/footer');
        } else {
