            ...
            <li class="nav-item active">
                ...
                <div id="collapse2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('user/menarabaru'); ?>">Menara Baru</a>
                        <a class="collapse-item" href="<?= base_url('user/menaraeksisting'); ?>">Menara Exsisting</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapse4" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('user/profil'); ?>">Profil</a>
                        <a class="collapse-item" href="<?= base_url('user/ubahpassword'); ?>">Ganti Password</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider">
